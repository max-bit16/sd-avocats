...
export default function Antonine() {
  useSEO({
    title: 'Antonine Darricau — Associée, SD Avocats Rennes',
    description: 'Antonine Darricau, avocate et cofondatrice de SD Avocats à Rennes. Spécialiste en droit commercial et droit du travail. Langues : FR, EN, DE.',
    canonical: 'https://www.sdavocats.fr/notre-equipe/antonine-darricau',
  })
            ...
            <div className="grid grid-cols-1 lg:grid-cols-[1fr_340px] gap-16">
              <div>
                ...
                <div className="space-y-5 text-base leading-7" style={{ color: '#7e7e7e' }}>
                  <p>
                    Antonine Darricau exerce son activité en droit commercial ainsi qu'en droit du travail, pour une clientèle d'entreprises françaises et internationales et de salariés.
                  </p>
                  <p>
                    Elle représente ses clients devant les juridictions civiles, commerciales et prud'hommales françaises. Antonine Darricau accompagne également ses clients dans le cadre de tous types de négociations tant en précontentieux que pour la conclusion de différents contrats commerciaux.
                  </p>
                  <p>
                    Après avoir exercé au sein de cabinets parisiens puis à Rennes, Antonine Darricau a fondé SD Avocats et dirige son <strong style={{ color: '#25282b' }}>bureau de Rennes</strong>.
                  </p>
                </div>
              ...
              <div className="flex flex-col gap-5">
                ...
                <div className="p-6" style={{ backgroundColor: '#f2f2f2', borderRadius: '6px' }}>
                  ...
                  <ul className="space-y-2 text-sm" style={{ color: '#25282b' }}>
                    {['Droit commercial', 'Droit du travail', 'Négociation précontentieuse', 'Contentieux prud\'homal'].map((d) => (
                ...
                <div className="p-6" style={{ backgroundColor: '#f2f2f2', borderRadius: '6px' }}>
                  ...
                  <p className="text-sm font-medium" style={{ color: '#25282b' }}>Français · Anglais · Allemand</p>
                </div>
              </div>
            </div>
